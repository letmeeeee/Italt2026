...
#define DEFAULT_MYSQL_HOME "/usr/local/database/mysql"
#define SHAREDIR "/usr/local/database/mysql/share"
#define DEFAULT_BASEDIR "/usr/local/database/mysql"
#define MYSQL_DATADIR "/usr/local/database/mysql/data"
#define MYSQL_KEYRINGDIR "/usr/local/database/mysql/keyring"
#define DEFAULT_CHARSET_HOME "/usr/local/database/mysql"
#define PLUGINDIR "/usr/local/database/mysql/lib/plugin"
...
#define MYSQL_VERSION_PATCH 35
#define MYSQL_VERSION_EXTRA ""
#define PACKAGE "mysql"
#define PACKAGE_BUGREPORT ""
#define PACKAGE_NAME "MySQL Server"
#define PACKAGE_STRING "MySQL Server 5.7.35"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "5.7.35"
#define VERSION "5.7.35"
