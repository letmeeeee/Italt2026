...
#define DEFAULT_MYSQL_HOME "/usr/local/mysql-5.7.27-aarch64"
#define SHAREDIR "/usr/local/mysql-5.7.27-aarch64/share"
#define DEFAULT_BASEDIR "/usr/local/mysql-5.7.27-aarch64"
#define MYSQL_DATADIR "/usr/local/mysql-5.7.27-aarch64/data"
#define MYSQL_KEYRINGDIR "/usr/local/mysql-5.7.27-aarch64/keyring"
#define DEFAULT_CHARSET_HOME "/usr/local/mysql-5.7.27-aarch64"
#define PLUGINDIR "/usr/local/mysql-5.7.27-aarch64/lib/plugin"
...
#define MYSQL_DEFAULT_COLLATION_NAME "utf8mb4_general_ci"
...
#define PACKAGE_STRING "MySQL Server 5.7.27"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "5.7.27"
#define VERSION "5.7.27"
